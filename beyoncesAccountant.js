var name = "Beyonce";
var beyoncesMoney = "total number.";

console.log("Dear " + name + " ,")
console.log("We have calculated your total earnings this year.")
console.log("You have earned " + beyoncesMoney)
console.log("Of " + parseInt(500 + 750 + 3000 + 5100 + 12980 + 9087 + 50000) + " some portion derives from your live performances.")
console.log("Of " + parseInt(500 + 750 + 3000 + 5100 + 12980 + 9087 + 50000) + " some portion derives from music sales.")
