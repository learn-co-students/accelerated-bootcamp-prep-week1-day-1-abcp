var sum_1 = 500 + 750 + 3000 + 5100 + 12980 + 9087 + 50000;
console.log("Dear Beyonce,")
console.log("We have calculated your total earnings this year.")
console.log("You have earned " + sum_1)
console.log("Of" + sum_1 + " some portion derives from your live performances.")
console.log("Of" + sum_1 + " some portion derives from music sales.")
